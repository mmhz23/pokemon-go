...
function loadDataWithAjax() {
  $.ajax({
    url: "https://raw.githubusercontent.com/mmhz23/pokemon-go/refs/heads/main/public/assets/data/pokemon.json",
    method: "GET",
    dataType: "json",
    headers: {
...
function loadDataWithGet() {
  $.get(
    "https://raw.githubusercontent.com/mmhz23/pokemon-go/refs/heads/main/public/assets/data/pokemon.json",
  )
    .done(function (data) {
      pokemonData = data.pokemon;
      updateCardBySearch("1");
